...
function renderWeeks(query = "") {
  ...
  grid.innerHTML = weeks.map((w, i) => {
    ...
    return `<a class="week-card ${i === 3 ? "current" : ""}" href="weeks/week-${i + 1}.html"><span class="week-no">${w[0]}</span><h3>${w[1]}</h3><p>${w[2]}</p></a>`;
...
let links = JSON.parse(localStorage.getItem("quickLinks") || "null") || [
  ["MDN", "https://developer.mozilla.org/"], ["YouTube", "https://www.youtube.com/"], ["Google", "https://www.google.com/"], ["GitHub", "https://github.com/"]
];
